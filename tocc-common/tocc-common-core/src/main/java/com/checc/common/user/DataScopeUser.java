 ...
 * @author checc
 */
public class DataScopeUser extends BaseEntity
{
    ...
    public DataScopeUser(Long userId)
    {
        this.userId = userId;
    }
    ...
    public List<DataScopeRole> getRoles()
    {
        return roles;
    }

    public void setRoles(List<DataScopeRole> roles)
    {
        this.roles = roles;
    }
