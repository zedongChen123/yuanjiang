package com.checc.common.redis.aspect;

import com.checc.common.redis.annotation.RedisCache;
import com.checc.common.redis.annotation.RedisEvict;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.checc.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.checc.common.redis.annotation.RedisEvict)")
