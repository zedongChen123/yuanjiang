package com.checc.common.security.service;

import com.checc.common.constant.Constants;
import com.checc.common.utils.IdUtils;
import com.checc.common.utils.ServletUtils;
import com.checc.common.utils.StringUtils;
import com.checc.common.utils.ip.AddressUtils;
import com.checc.common.utils.ip.IpUtils;
...
public class TokenService
{
    ...
    public LoginUser getLoginUser(HttpServletRequest request)
    {
        ...
        if (StringUtils.isNotEmpty(token))
        {
            ...
            LoginUser user = redisCache.get(userKey,LoginUser.class);
            return user;
        }
        return null;
    }

    public LoginUser getUser(String userToken)
    {
